...
public class Enemy_AI_script : MonoBehaviour, MouseDownOverrider
{
    ...
    protected void conversionUpdate()
    {
        ...
        else if(Enemy_Spawning_And_Horde_Manager_Script.hasHordeHasSpawnedAllEnemies() && GameObject.FindGameObjectsWithTag("Enemy").Length == 1)
        {
            conversionFailed();
        }
    ...
    public void die()
    {
        ...
        Enemy_Spawning_And_Horde_Manager_Script.addBattleStat_Kills(1);
        isDying = true;
